<div class="entry-content">
  ...
  <div class="vv-map-container entry-content__right-column">
    ...
    <div class="vv-map-legend">
      ...
      <p class="legend-credits">
        Carte
        <a target="_blank" href="https://github.com/VraimentVraiment/cheminsruraux">
          réalisée par Vraiment Vraiment</a> avec tilemaker et
        mapboxgl.js,
        <a target="_blank" href="https://download.geofabrik.de/europe/france.html">
          données OSM
        </a>
        Novembre 2022
      </p>
